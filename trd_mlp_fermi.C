...
int fill_trees(TTree *ttree_hits, TTree *signal, TTree *background, TTree *sig_tst, TTree *bg_tst, int RunNum, int *rtw1, int *rtw3) {
  ...
  //========================================
  TH2F *hits2d_e = new TH2F("hits2d_e","Electron dEdx in Time;Time (*8ns);Channel",100,0.5,300.5,240,-0.5,239.5);
  TH2F *hits2d_pi = new TH2F("hits2d_pi","Pion dEdx in Time;Time (*8ns);Channel",100,0.5,300.5,240,-0.5,239.5);
  
  TH2F *aver2d_e = new TH2F("aver2d_e","aver-rms electrons",100,0.,240.,100,0.,100.);
  TH2F *aver2d_pi = new TH2F("aver2d_pi","aver-rms pions",100,0.,240.,100,0.,100.);
  ...
  TH1F *helectron_dedxtotal = new TH1F("helectron_dedxtotal","Electron e_total",600,0.5,100000.5);
  TH1F *hpion_dedxtotal = new TH1F("hpion_dedxtotal","Pion e_total",600,0.5,100000.5);
  
  TH1F *time_e  = new TH1F("time_e","Electron Amplitude in Time;Time (*8ns)",330,0.5,330.5);
  TH1F *time_pi = new TH1F("time_pi","Pion Amplitude in Time;Time (*8ns)",330,0.5,330.5);
  ...
  for (Long64_t iev = 0; iev < nentries; iev++) {
    ...
    if ( 3000 < RunNum && RunNum <= 3999 ) { //------------------  FERMILAB   2023  ---------------------
      ...
      case 3125:   tw1=108; tw2=153; tw3=184; e_chan1=80;   e_chan2=140;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Single Fleece (lrg)
      case 3126:   tw1=108; tw2=153; tw3=184; e_chan1=80;   e_chan2=140;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Single Fleece (lrg)
      case 3131:   tw1=108; tw2=153; tw3=184; e_chan1=80;   e_chan2=140;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Single Fleece (lrg)
      
      case 3132:   tw1=108; tw2=153; tw3=184; e_chan1=85;   e_chan2=165;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Single Foil (VU)
      case 3133:   tw1=108; tw2=153; tw3=184; e_chan1=85;   e_chan2=165;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Single Foil (VU)
      case 3134:   tw1=108; tw2=153; tw3=184; e_chan1=85;   e_chan2=165;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Single Foil (VU)
      
      case 3196:   tw1=107; tw2=148; tw3=186; e_chan1=93;   e_chan2=147;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Double Foil
      ...
      case 3200:   tw1=107; tw2=150; tw3=186; e_chan1=93;   e_chan2=147;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Double Foil
      
      case 3201:   tw1=107; tw2=148; tw3=186; e_chan1=89;   e_chan2=148;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Double Fleece
      case 3202:   tw1=107; tw2=150; tw3=186; e_chan1=89;   e_chan2=148;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- Double Fleece
      
      case 3203:   tw1=107; tw2=148; tw3=186; e_chan1=89;   e_chan2=148;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- No Rad
      case 3204:   tw1=107; tw2=148; tw3=186; e_chan1=89;   e_chan2=148;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break; //-- No Rad
      ...
      case 3216:   tw1=108; tw2=153; tw3=184; e_chan1=100;  e_chan2=185;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break;
      case 3248:   tw1=108; tw2=153; tw3=184; e_chan1=120;  e_chan2=190;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break;
      case 3250:   tw1=108; tw2=153; tw3=184; e_chan1=120;  e_chan2=190;  pi_chan1=e_chan1;   pi_chan2=e_chan2;   break;

      
        default:    tw1=108;  tw2=160;  tw3=185;
      }
    } else {
      printf("Run %d not found in the FERMI 2023 range - exiting \n",RunNum);
      exit(1);
    }
