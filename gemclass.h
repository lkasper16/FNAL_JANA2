...
#ifdef gemclass_cxx
gemclass::gemclass(int RunNum_in) : fChain(0) 
{
  RunNum=RunNum_in;
  TTree *tree=NULL;
...
Int_t gemclass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gemclass::LoadTree(Long64_t entry)
{
...
void gemclass::Show(Long64_t entry)
{
...
Int_t gemclass::Cut(Long64_t entry)
{
