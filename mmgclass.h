...
#ifdef mmgclass_cxx
mmgclass::mmgclass(int RunNum_in) : fChain(0)
{
  RunNum=RunNum_in;
  TTree *tree=NULL;
...
Int_t mmgclass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mmgclass::LoadTree(Long64_t entry)
{
...
void mmgclass::Show(Long64_t entry)
{
...
Int_t mmgclass::Cut(Long64_t entry)
{
